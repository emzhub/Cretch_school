...
@section('title') Add Parent @endsection
...
<!-- Start your project here-->
  ...
  <div class="row">
              ...
              <div class="col-lg-10 col-lg-offset-2">
               ...
               <form id="send-announcement-form" role="form"  method="POST" action="{{route('add_parent')}}">
                                    @csrf
                                    <div id="cat_fields">
                    ...
                    <!--     <span class="glyphicon glyphicon-user form-control-feedback"></span> -->
                        ...
                        <div class="form-group has-feedback">
                        <input type="text"  placeholder="Home address" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{ old('address') }}"  autofocus>
